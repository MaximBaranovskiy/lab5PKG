...
static constexpr auto qt_meta_stringdata_CLASSplotENDCLASS = QtMocHelpers::stringData(
    "plot"
);
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSplotENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSplotENDCLASS_t qt_meta_stringdata_CLASSplotENDCLASS = {
    {
